...
#PATH_TO_TRAINED_MODEL = os.path.join('models', args.model)
...
model = nin.NIN()
if os.path.exists('./models/modelhdf5'):
    print('load model...')
    serializers.load_hdf5('./models/modelhdf5', model)
...
def train_loop():
    while True:
        ...
        # Save final model
        serializers.save_hdf5('./models/modelhdf5%04d'%epoch_count, model)
...
if __name__ == '__main__':
    ...
    # Save final model
    serializers.save_hdf5('./models/modelhdf5', model)
